  ...
  return (
    <div>
      <Helmet>
        ...
        <meta
          name='description'
          content='Project page from  thierno souleymane diallo'
        />
      </Helmet>
      <Navbar />
      <ProjectBanner mainImage={mainImage} sideImage={mountain} />
      <SingleProject
        img={project.first.img}
        alt={project.first.alt}
        projectTitle={project.first.proTitle}
        briefDescription={project.first.proBDesc}
        description={project.first.proDesc}
        showButton
        hostname='Heroku'
        bgColor='#eee'
      />
      <SingleProject
        img={project.second.img}
        alt={project.second.alt}
        projectTitle={project.second.proTitle}
        briefDescription={project.second.proBDesc}
        description={project.second.proDesc}
        showButton={false}
        hostname='Heroku'
        bgColor='#e3e3e3'
      />
